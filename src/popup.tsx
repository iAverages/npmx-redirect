        ...
        <div className="w-80 bg-zinc-900 text-zinc-200 font-sans text-sm leading-normal">
            <div className="p-5 bg-zinc-950 border-b border-zinc-800 flex items-center gap-3">
                <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#cb3837] to-[#e53e3e] rounded-lg flex items-center justify-center font-bold text-[10px] text-white tracking-wide shadow-[0_4px_12px_rgba(203,56,55,0.3)]">
                        LOGO
                    </div>
                </div>
